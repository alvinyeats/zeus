...
def start():
    ...
    try:
        ...
        parser_group_target.add_argument("-d", dest="domain", nargs="+", help="Domain to search or company name")
        ...
        parser_group_domain.add_argument("-st", dest="search thread", nargs="?", help="Search thread")
